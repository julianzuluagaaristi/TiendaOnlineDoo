...
public final class EliminarClienteFacade implements Facade<ClienteDTO>{
	...
	public final void execute(final ClienteDTO dto) {
		...
		try {
			...
			daoFactory.cancelarTransacion();
			var mensajeUsuario = CatalogoMensajes.obtenerContenidoMensaje(CodigoMensaje.M0000122);
			var mensajeTecnico = CatalogoMensajes.obtenerContenidoMensaje(CodigoMensaje.M0000123);
